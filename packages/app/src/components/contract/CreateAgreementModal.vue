  ...
  <Popup :opened="isOpen">
    <div class="create-agreement-modal">
      ...
      <div class="modal-footer">
        <button type="button" class="btn-secondary" @click="handleClose" :disabled="isCreatingAgreement || isAdopting">
...
watch(
  ...
  (isOpen) => {
    if (isOpen) {
      ...
      formData.bountyPercentage = 10;
      formData.bountyCap = "5000000";
      formData.allowAnonymous = true;
      formData.contactEmail = "";
      formData.contactDiscord = "";
      formData.contactTelegram = "";
      formData.assetRecoveryAddress = "" as Address;
      formData.agreementURI = "";
    }
  }
);
</script>
