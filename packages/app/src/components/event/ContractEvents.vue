...
.contract-events-container {
  @apply rounded-t-none shadow-none md:rounded;
  ...
  table {
    ...
    td {
      ...
      &:before {
        @apply absolute left-4 top-2.5 whitespace-nowrap pr-5 text-left text-xs uppercase content-[attr(data-heading)] md:content-none;
