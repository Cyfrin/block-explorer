...
-- Using minimal valid bytecode: PUSH1 0x00 PUSH1 0x00 RETURN (600060006000f3)
INSERT INTO addresses (address, bytecode) VALUES
  ('\x0000000000000000000000000000000000000001', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000002', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000003', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000004', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000005', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000006', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000007', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000008', '\x600060006000f3'),
  ('\x0000000000000000000000000000000000000009', '\x600060006000f3')
ON CONFLICT (address) DO UPDATE SET bytecode = EXCLUDED.bytecode;

-- Insert agreement contract addresses (0xaaaa...) so they also show as contracts
INSERT INTO addresses (address, bytecode) VALUES
  ('\xaaaa000000000000000000000000000000000003', '\x600060006000f3'),
  ('\xaaaa000000000000000000000000000000000004', '\x600060006000f3'),
  ('\xaaaa000000000000000000000000000000000005', '\x600060006000f3'),
  ('\xaaaa000000000000000000000000000000000006', '\x600060006000f3'),
  ('\xaaaa000000000000000000000000000000000007', '\x600060006000f3'),
  ('\xaaaa000000000000000000000000000000000008', '\x600060006000f3'),
  ('\xaaaa000000000000000000000000000000000009', '\x600060006000f3')
ON CONFLICT (address) DO UPDATE SET bytecode = EXCLUDED.bytecode;
...
CREATE TABLE IF NOT EXISTS battlechainindexer_attack_registry.agreement_owner_authorized (
  ...
  registered_contract_address CHAR(42) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_agreement_owner_authorized_contract
  ON battlechainindexer_attack_registry.agreement_owner_authorized(registered_contract_address);

-- Clear existing seed data
DELETE FROM battlechainindexer_attack_registry.agreement_owner_authorized
WHERE registered_contract_address IN (
